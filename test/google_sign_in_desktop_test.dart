      ...
      group(
        ...
        () {
          ...
          test(
            ...
            () async {
              plugin.tokenDataStore = tokenDataStore.._value = _GoogleSignInDesktopTokenData();
...
class _GoogleSignInDesktopTokenDataStore implements GoogleSignInDesktopStore<GoogleSignInDesktopTokenData> {
